        ...
        <div>
            ...
            <div class="flex sm:w-9/12  flex-col lg:flex-row justify-center items-center lg:space-x-10 2xl:space-x-36 space-y-12 lg:space-y-0 lg:w-[75rem] pt-64 sm:pt-0">
                <div class="flex w-full flex-col justify-start items-start">
                    ...
                    <div class="mt-2">
                        <a href="1" class="text-base dark:text-gray-400 leading-4 focus:outline-none focus:underline hover:underline hover:text-gray-800 text-gray-600">Back to my bag</a>
                    </div>
                    <div class="mt-12">
                        <p class="text-lg dark:text-white leading-4 text-gray-800">Sign in or continue as <a href="1" class="focus:outline-none dark:text-white hover:underline font-semibold focus:underline focus:underline">guest?</a></p>
                    </div>
                    ...
                    <div class="mt-4 flex justify-between items-center w-full">
                        <a href="1" class="focus:outline-none dark:text-gray-400 focus:underline hover:underline text-sm leading-none text-gray-600">Forgot password?</a>
                        <a href="1" class="focus:outline-none dark:text-gray-400 focus:underline hover:underline text-sm leading-none text-gray-600">Creat an account</a>
                    </div>
                </div>
