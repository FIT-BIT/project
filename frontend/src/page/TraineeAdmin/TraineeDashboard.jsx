  ...
  return (
    <>
      <div class="bg-gray-100 ">
        <aside class="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]  ">
          <div>
            <div class="-mx-6 px-6 ">
              <a href="1" title="home">
        ...
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
          <div class="sticky top-0 h-16 border-b bg-white   lg:py-2.5">
            <div class="flex items-center justify-between space-x-4 px-6 2xl:container">
              {/* <h5
                hidden
                class="text-2xl z-50 font-medium text-gray-600 lg:block "
              >
                Dashboard
              </h5> */}
          ...
          <div class="px-6 pt-6 2xl:container">
            <div class="flex h-[210vh] items-center justify-center rounded-xl border-2 border-dashed border-gray-300 ">
              <Routes>
                ...
                <Route path='/report_analysis' element={<ProgressReport />} />
                <Route
